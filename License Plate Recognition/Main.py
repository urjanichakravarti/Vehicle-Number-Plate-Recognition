...
def drawRedRectangleAroundPlate(imgOriginalScene, licPlate):
    ...
    cv2.line(imgOriginalScene, (int(p2fRectPoints[0][0]), int(p2fRectPoints[0][1])),
             (int(p2fRectPoints[1][0]), int(p2fRectPoints[1][1])), SCALAR_RED, 2)  # draw 4 red lines
    cv2.line(imgOriginalScene, (int(p2fRectPoints[1][0]), int(p2fRectPoints[1][1])),
             (int(p2fRectPoints[2][0]), int(p2fRectPoints[2][1])), SCALAR_RED, 2)
    cv2.line(imgOriginalScene, (int(p2fRectPoints[2][0]), int(p2fRectPoints[2][1])),
             (int(p2fRectPoints[3][0]), int(p2fRectPoints[3][1])), SCALAR_RED, 2)
    cv2.line(imgOriginalScene, (int(p2fRectPoints[3][0]), int(p2fRectPoints[3][1])),
             (int(p2fRectPoints[0][0]), int(p2fRectPoints[0][1])), SCALAR_RED, 2)
